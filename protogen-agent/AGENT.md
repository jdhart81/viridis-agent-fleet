...
```bash
curl -s https://mcp.viridisconservation.com/protogen/mcp \
  -H 'content-type: application/json' \
  -H 'accept: application/json, text/event-stream' \
  -d '{"jsonrpc": "2.0", "id": 1, "method": "tools/call", "params": {"name": "create_cad_workspace", "arguments": {"project_name": "sensor-housing-v1", "owner_agent": "agent:acme-hardware-bot", "design_goal": "weatherproof IoT sensor enclosure", "constraints": {"max_size_mm": 120, "material": "abs"}}}}'
```
...
```json
{
  "status": "success",
  "workspace": {
    "workspace_id": "cad-20260716043717-1",
    "project_name": "sensor-housing-v1",
    "owner_agent": "agent:acme-hardware-bot",
    "design_goal": "weatherproof IoT sensor enclosure",
    "constraints": {
      "max_size_mm": 120,
      "material": "abs"
    },
    ...
    "design_ids": [],
    "created_at": "2026-07-16T04:37:17.364875"
  },
  "timestamp": "2026-07-16T04:37:17.364877"
}
```
