...
BASE = "sha256:0636665c3496b3b03dabe2db034e4891d5ececb6399bd93e3923a8c3d356ff0f"
LIVE = "viridis-fleet-gateway-1"
ROOT = Path("/root/viridis-candidates/discovery-canonical-20260909")
SOURCE = Path("/root/viridis-fleet")
ROLLBACK = "viridis-stable:rollback-discovery-canonical-20260909"
CANDIDATE = "viridis-stable:discovery-canonical-20260909"
...
def verify_surface(base, label):
    ...
    assert status == 200
    assert "https://mcp.viridis-security.com/security-preflight — supplied" in body
