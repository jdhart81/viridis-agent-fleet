#!/usr/bin/env python3
"""Exact-image, copied-state rollout for the authorized agent discovery update.
...
BASE = "sha256:d31d4a3c9e0ee548a791239e12d2af6f18b4a291e54423867ac21c802482b672"
LIVE = "viridis-fleet-gateway-1"
ROOT = Path("/root/viridis-candidates/agent-discovery-20260906")
SOURCE = Path("/root/viridis-fleet")
ROLLBACK = "viridis-stable:rollback-agent-discovery-20260906"
CANDIDATE = "viridis-stable:agent-discovery-20260906"
