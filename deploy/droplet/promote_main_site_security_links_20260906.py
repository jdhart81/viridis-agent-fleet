...
OLD_COMMIT = '926cd1a7a55b873756ae41cd40fa257491ee564e'
BASE = 'sha256:1f304b95703ab46cc5362b024077eb76def53270b2d626fabc301ffbc0b50f40'
LIVE = 'viridis-app'
ENV = Path('/home/deploy/viridis-conservation/.env.local')
TAG = 'viridis-conservation:release-17afb0b4e90b'
ROLLBACK = 'viridis-conservation:rollback-926cd1a7a55b-security-domain'
TRIAL = 'viridis-security-links-rehearsal'
LINK = 'https://mcp.viridis-security.com/security-preflight'
...
def verify(base, commit):
    ...
    for path in ['/', '/developers']:
        ...
        if path=='/developers':
            assert 'Security Preflight' in page and 'https://mcp.viridis-security.com/security-preflight/service.json' in page
...
def promote():
    ...
    assert 'MCP Security Preflight' in get('https://mcp.viridis-security.com','/security-preflight')
