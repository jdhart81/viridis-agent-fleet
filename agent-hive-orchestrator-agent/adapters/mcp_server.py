...
async def describe_agent() -> str:
    ...
    described["pricing"].update({
        ...
        "currency": "USD",
        "free_per_day": FREE_SOLVES_PER_DAY,
        "free_scope": (
            "no free model-backed execution; read-only tools and unpaid "
            "preflight remain free"),
        "max_solver_settlement_minor": MAX_SOLVER_SETTLEMENT_MINOR,
        "max_provider_api_cost_usd": MAX_API_COST_USD,
        "provider_service_tier": OPENAI_SERVICE_TIER,
